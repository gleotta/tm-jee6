...
public class CompraServiceImpl implements CompraService {
	...
	public List<Compra> obtenerCompras() {
		return (List<Compra>) entityManager.createQuery(
				"select c from Compra c").getResultList();
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<Compra> obtenerComprasUsuario(String username) {
		return (List<Compra>) entityManager
				.createQuery(
						"select c from Compra c where c.usuario.email = :username")
	...
	public List<Compra> obtenerComprasProducto(String codigoProd) {
		...
		return (List<Compra>) entityManager
				.createQuery(
						"select c from Compra c where c.producto.codigo = :codigo")
				.setParameter("codigo", codigoProd).getResultList();
	...
	public void crearCompra(String username, String producto)
		...
		crearCompra(username, producto, new Date());

	}

	@Override
	public void crearCompra(String username, String producto, Date date)
			throws BusinessException {
